# Who’s Turn?
A lightweight iOS app to fairly pick the next presenter (or any turn-based selection) from your team. Built with SwiftUI, Swift Concurrency, and a modular architecture.
...
- Fair picker
  ...
  - Clear “spin” animation and confetti celebration
- Exclusions
...
- Custom design system with glass effects and animations
...
- Data access through feature-specific datasources
  - PickerDatasource and TeamSetupDatasource abstract WTStorage
